...
public class ServerMainThread {
    ...
    public static class WaitForCompletion<T> {
        ...
        private Object catchResult() {
            ...
            Bukkit.getScheduler().scheduleSyncDelayedTask(McTiktokGiftActions.getPlugin(McTiktokGiftActions.class), () -> {
                try {
    ...
    public static class RunParallel {
        ...
        public static void run(Runnable runnable) {
            ...
            Bukkit.getScheduler().scheduleSyncDelayedTask(McTiktokGiftActions.getPlugin(McTiktokGiftActions.class), runnable);
        }
